...
public class ComponentManager
{
	...
	private final TrawlingConfig config;
	...
	{
		if (!TrawlingConfig.CONFIG_GROUP.equals(e.getGroup()))
		{
			return;
		}
	...
	private void tryStartUp(PluginLifecycleComponent component)
	{
		...
		{
			log.debug("Enabling Trawling component [{}]", component.getClass().getName());
		}
		...
		{
			log.error("Failed to start Trawling component [{}]", component.getClass().getName(), e);
		}
	}
	...
	private void tryShutDown(PluginLifecycleComponent component)
	{
		...
		if (log.isDebugEnabled())
		{
			log.debug("Disabling Trawling component [{}]", component.getClass().getName());
		}
		...
		{
			log.error("Failed to cleanly shut down Trawling component [{}]", component.getClass().getName());
		}
		finally
		{
